    ...
    */
    ...
    Exercise 1.2.27
        ...
        Gaussian random numbers. One way to generate a random number taken from the Gaussian distribution is to use the Box-Muller formula
            ...
            w = sin(2 pi v)(-2lnu)^(1/2)

        where u and v are real numbers between 0 and 1 generated by the Math.random() method. Write a program that prints out a standard Gaussian random variable.

     */
    public void oneTwoTwentyseven() {
